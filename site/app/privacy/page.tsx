...
export const metadata: Metadata = {
  title: { absolute: "Privacy — CHRM" },
  description: "How CHRM handles conversation data, CRM data and credentials.",
  ...
  return (
    <PageShell current="privacy">
      <main className="sp-page" id="top">
        <p className="sp-crumbs"><Link href="/">CHRM</Link><span>/</span><span style={{ color: "var(--ink)" }}>Privacy</span></p>
        ...
        <section className="sp-body">
          <div className="sp-prose">
            <p>CHRM connects to your CRM, calendar, email, LinkedIn and Apollo over OAuth or per-user API keys. We do not store your passwords or CRM credentials.</p>
            <p>Conversation transcripts are processed to extract the structured fields your team has configured, then discarded. Only the structured output, drafted messages and activity records are written to your CRM and kept in your CHRM workspace.</p>
