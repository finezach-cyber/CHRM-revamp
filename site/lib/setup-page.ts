...
export const SETUP_PAGE: PageData = {
  ...
  prose: [
    ...
    '2nd Closer doesn&rsquo;t. You sign into four things. We read your CRM schema and your calendar. The execution layer turns on. From OAuth click to first call processed is less than a business day.',
    { h: 'Step 01 — your CRM.' },
    'OAuth into HubSpot or Pipedrive. 2nd Closer reads every pipeline, every stage, every custom field. You don&rsquo;t configure a schema; we read the one you already have. Fifteen minutes.',
    { h: 'Step 02 — your calendar.' },
    'Connect Google or Microsoft. 2nd Closer&rsquo;s built-in notetaker now joins every booked call on your team&rsquo;s calendar. No third-party notetaker required. If you use Fireflies, Fathom, or Otter, we ingest their output too. Five minutes.',
    { h: 'Step 03 — LinkedIn.' },
  ...
  bullets: [
    ...
    ['Step 02 · Your calendar', 'Google or Microsoft. 2nd Closer\u2019s notetaker joins every booked call. 5 minutes.'],
  ...
  shotHint: 'Four OAuth sign-ins. Zero workflow design. 2nd Closer is now running.',
