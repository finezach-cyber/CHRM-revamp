...
const RAW_COMPARE_PAGES: ComparePageData[] = [
  ...
  // ───────────────────────────────────────────────────────────────
  {
    ...
    rows: [
      ...
      { cap: "Cost in year one", them: N("$132k–$241k salary, or $42k–$180k of retainer, plus the tools"), chrm: Y("A per-AE subscription, quoted on the intro call. Other seats free. No tools to buy.") },
  ...
  // ───────────────────────────────────────────────────────────────
  {
    ...
    rows: [
      ...
      { cap: "Pricing", them: P("Was $69/user/mo; now bundled into Salesforce"), chrm: Y("Per AE, shared on the intro call; other seats free") },
    ],
